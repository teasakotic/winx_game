#ifndef EINX_HPP_INCLUDED
#define WINX_HPP_INCLUDED
#include <SDL2/SDL.h>
...
public:
    winx(double xx, double yy, double s, double d, double leva, double desna, SDL_Texture* texture): levaIvicaPuta(leva), desnaIvicaPuta(desna) {
        r.x = xx;
        r.y = yy;
        r.w = s;
        r.h = d;
